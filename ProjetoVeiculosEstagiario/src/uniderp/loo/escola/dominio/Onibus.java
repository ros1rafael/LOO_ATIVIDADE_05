...
public class Onibus extends BaseTransportes{
    private int codidoItenerario;
    private String empresa;
    public int getCodidoItenerario() {
        return codidoItenerario;
    }
    public void setCodidoItenerario(int codidoItenerario) {
    ...
    public Onibus(int codigo, String nome, String modelo, String fabricante, String cor, String chassi,
            ...
            String placa, int anoModelo, String codigoRenavam, int portas, int eixos, int codidoItenerario,
            String empresa) {
    ...
    public void Imprimir(){
        ...
        System.out.println("Codigo do Itinerario "+ this.codidoItenerario);
